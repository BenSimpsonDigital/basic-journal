...
private typealias SettingsLayout = ReminSurfaceLayout
                ...
                GeometryReader { proxy in
                    ...
                    ScrollView(showsIndicators: false) {
                        VStack(spacing: Theme.Spacing.lg) {
                            ...
                            ReminSectionCard(title: "Profile") {
                            ...
                            ReminSectionCard(title: "Reminders") {
                                VStack(spacing: 0) {
                                    SettingsToggle(
                                        icon: .bell,
                            ...
                            ReminSectionCard(title: "Privacy") {
                                SettingsPrivacyRow()
                            }

                            ReminSectionCard(title: "About") {
                                VStack(spacing: 0) {
                                    SettingsInfoRow(
            ...
            GeometryReader { proxy in
                ...
                ScrollView(showsIndicators: false) {
                    VStack(spacing: Theme.Spacing.lg) {
                        ...
                        ReminSectionCard(title: "Profile Photo") {
